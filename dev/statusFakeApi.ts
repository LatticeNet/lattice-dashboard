...
const FLEET: FleetEntry[] = [
  ...
  { name: "[Metix]-Aaitr-jp-softbank-NAT", ip: "203.0.113.20", host: "C202605271476532", os: "Alpine 3.20", status: "online", country: "JP", sinceMs: 8 * DAY, cpu: 2 },
  ...
  // The production fleet's widest name cells, so the Nodes table can be
  // checked against the names that used to truncate.
  { name: "[OpenJobs-Data]-TiDB-1", ip: "203.0.113.24", host: "ip-10-0-12-184.ec2.internal", os: "Ubuntu 22.04", status: "online", country: "SG", sinceMs: 12 * DAY, cpu: 63 },
  { name: "[OpenJobs-Data]-scripts", ip: "203.0.113.25", host: "ip-10-0-8-182.ec2.internal", os: "Ubuntu 22.04", status: "online", country: "SG", sinceMs: 12 * DAY, cpu: 58 },
  ...
  { name: "[cd]-Akkocloud-UK-London-KVM", ip: "203.0.113.35", host: "vm71132.akkocloud.com", os: "Ubuntu 24.04", status: "online", country: "GB", sinceMs: 25 * DAY, cpu: 26 },
