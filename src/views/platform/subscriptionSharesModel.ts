 ...
 * /platform/publishing?origin=share&create=1&for=<name>, the create form
 * prefills the subscription id and offers a slug derived from the record name.
 * The suggestion is only a starting point: it must already satisfy the server's
