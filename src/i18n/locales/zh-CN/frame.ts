...
export default {
  common: {
    ...
    nodeStatusHint: {
      online: "最近 90 秒内有上报,且没有探测到故障。",
      degraded: "仍在上报,但节点上的探测表明有组件出了故障。",
      offline: "已停止上报。节点静默超过 90 秒后,控制平面不再信任它。",
      neverReported: "已接入,但从未收到过上报。agent 没有安装,或从未连上控制平面。",
      disabled: "已被操作员停用。重新启用前,agent 令牌会被拒绝。",
    },
    status: {
      neverReported: "从未上报",
      active: "活跃",
  ...
  overview: {
    ...
    fleet: "机群",
    fleetHealth: "机群健康",
    acrossLive: "统计自 {count} 个在上报且带指标的节点",
    summary: {
      download: "下载",
      upload: "上传",
      regions: "地区",
    ...
    trustPosture: {
      title: "信任姿态",
      description:
        "汇总执行权限、终端权限、来源策略和账号保护。其中执行和终端只统计 agent 最近一次上报的运行态：server 重启后还没上报过的节点，在这里会被算作什么都没开。",
      clean: "未计到风险",
      review: "需检查",
      rootExec: "Root 执行节点",
    ...
    offlineCount: "{count} 个未上报",
    allOnline: "全部节点都在上报",
    fleetOnline: "{total} 个节点中有 {online} 个在线",
    fleetAllHealthy: "全部节点在线",
    fleetAllHealthyHint: "{count} 个节点在线,没有降级、离线、停用或从未上报的节点。",
    fleetNeedsAttention: "需要关注",
    fleetHealthyCount: "{count} 个在线",
    fleetMoreNeedAttention: "还有 {count} 个需要关注",
    approvalsDescription: "等待审核的待处理变更",
    noPendingApprovals: "暂无待审批",
    everythingUpToDate: "没有需要你处理的事项。",
    recentActivityDescription: "最新审计决策",
    noRecentActivity: "暂无近期活动",
    auditWillAppear: "运维操作产生的放行与拒绝决策会出现在这里。",
    metric: {
      cpu: "CPU",
      memory: "内存",
      disk: "磁盘",
