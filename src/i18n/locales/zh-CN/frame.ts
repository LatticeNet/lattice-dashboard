...
export default {
  ...
  overview: {
    ...
    fleet: "机群",
    fleetHealth: "机群健康",
    acrossLive: "统计自 {count} 个上报了指标的节点",
    summary: {
      download: "下载",
      upload: "上传",
      regions: "地区",
    ...
    allOnline: "全部节点都在上报",
    fleetOnline: "{total} 个节点中有 {online} 个在上报",
    fleetAllHealthy: "全部节点上报正常",
    fleetAllHealthyHint: "{count} 个节点在线,没有降级、停用或待注册的节点。",
    fleetNeedsAttention: "需要关注",
    fleetHealthyCount: "{count} 个正常",
