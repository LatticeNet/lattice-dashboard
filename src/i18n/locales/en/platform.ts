...
export default {
  platform: {
    ...
    storage: {
      ...
      bucketsDescription: "A bucket is one named store of keys or objects. A route and an access token both name a bucket, so a bucket needs a record here before anything can point at it.",
