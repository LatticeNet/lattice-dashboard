  ...
  fleet: {
    ...
    inventory: {
      ...
      profile: {
        ...
        priceHintOneTime: "What the machine cost. Leave blank for a free machine.",
        node: "Node",
        label: "Label",
        vendor: "Vendor",
        ...
        nextRenewalSuggested: "Filled in from the purchase date and not saved yet. Save to keep it.",
        renewalCycle: "Renewal cycle",
        cycleDays: "Cycle days",
        cycleDaysInvalid: "Enter how many days one cycle lasts: a whole number, 1 or more.",
        ...
        reminderDaysEmpty: "Enter at least one day, for example 14,7,1.",
        reminderDaysIgnored: "Ignored {values}. Use whole days from 0 to 365.",
        ...
        renewalInvalidHint: "Fix renewal options before saving: custom days needs a positive day count, auto-roll needs a cycle, and enabled reminders need a renewal date and at least one day.",
        ...
        sectionRenewal: "Renewal",
        links: "Console and detail links",
        linksStored: "{count} stored",
        linksNone: "none stored",
        vendorDetails: "Vendor details",
        vendorDetailsEmpty: "no site, logo or notes yet",
        modeLabel: "How this machine is paid for",
        modeOneTime: "One-time or free",
        modeRecurring: "Recurring",
        cycleNotSet: "Choose a cycle",
        cycleDaysMissing: "custom cycle, days not set",
        monthlyEquivalent: "About {amount}/mo",
        summaryNextRenewal: "next renewal {date}",
        summaryRemindersOn: "reminders {days} days before",
        summaryRemindersNoDays: "reminders on, no days set",
        summaryRemindersOff: "reminders off",
        useCalculatedDate: "Use {date}, from the purchase date",
        useRolledForwardDate: "Use {date}",
        recordRenewalAutoRoll: "Recording a renewal moves the next renewal from {from} to {to}.",
        recordRenewalAutoRollStillPast: "Recording a renewal moves the next renewal from {from} to {to}, which is still in the past.",
        recordRenewalManual: "Recording a renewal sets the next renewal to {date}.",
        recordRenewalManualPast: "{date} has already passed, so recording a renewal with it leaves the machine overdue.",
        recordRenewalSaveFirst: "Save or discard your other changes first. Recording a renewal reloads the saved profile.",
        discardTitle: "Discard changes to {name}?",
        discardDescription: "The edits in this form are not saved. Closing it throws them away.",
