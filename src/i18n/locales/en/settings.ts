  ...
  settings: {
    ...
    security: {
      ...
      passkeys: {
        ...
        never: "never",
        added: "Passkey added",
        addFailed: "Could not add the passkey",
        deleted: "Passkey removed",
        deleteTitle: "Remove this passkey?",
        deleteConfirm: "“{name}” will no longer be able to sign in to this account.",
        stepUpTitle: "Confirm it's you",
        stepUpDescription:
          "Managing passkeys is sensitive. Use an authenticator code or an existing passkey to continue.",
        stepUpCode: "Authenticator code",
        stepUpPasskey: "Use passkey",
        stepUpConfirm: "Confirm",
        stepUpRequired: "Second-factor verification is required.",
        stepUpFailed: "Authenticator code verification failed.",
        stepUpPasskeyFailed: "Passkey verification failed.",
        stepUpCancelled: "Verification cancelled.",
      },
    ...
    users: {
      title: "Users",
      description: "Operator accounts and the RBAC scopes each one holds",
      newUser: "New user",
      ...
      form: {
        ...
        scopesRequired: "Select at least one scope (or grant full admin).",
        noGrantableScopes: "You cannot grant any scopes.",
        password: "Password",
        passwordPlaceholderCreate: "set an initial password, or leave blank for SSO-only",
