  ...
  networking: {
    sshGuard: {
      ...
      knock: {
        ...
        commandLabel: "Run one of these from the address you will connect from",
        copyCommand: "Copy command",
        copyKnockCommand: "Copy the knock client command",
        copyBashCommand: "Copy the bash command",
        commandKnock: "knock client (recommended)",
        commandKnockHint: "Install it once:",
        commandBash: "bash only",
        commandBashHint: "Nothing to install. bash sends each datagram through /dev/udp, which macOS and the common Linux distributions support.",
