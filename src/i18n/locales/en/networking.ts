...
export default {
  networking: {
    ...
    guard: {
      title: "NetGuard Firewall",
      description:
        "Plugin-owned nftables control plane: zones, security groups, node bindings, and reviewed lattice_guard plans",
      newInputs: "New inputs",
      statRenderer: "Renderer",
      statRendererHint: "nftables table, default drop, approval-gated apply.",
      statZones: "Zones",
      statTrustedZones: "{count} trusted zone refs",
      statGroups: "Security groups",
      statRules: "{count} ordered rules",
      statBindings: "Node bindings",
      statLegacy: "{count} observe-only legacy",
      modelTitle: "Security group model",
      modelDescription:
        "Design-13 NetGuard read model from /api/netguard: builtin zones, reusable groups, per-node bindings, and explicit adoption before planning.",
      modelNoScope: "netguard:read is required for the security-group model. Legacy nft inputs remain visible below.",
      modelUnavailable: "NetGuard model could not be loaded. Showing the legacy nft inputs below.",
      zonesTitle: "Zones",
      groupsTitle: "Groups",
      bindingsTitle: "Bindings",
      builtin: "builtin",
      resolvedPerNode: "resolved per node",
      noZones: "No zones visible.",
      noGroups: "No groups visible.",
      noBindings: "No node bindings visible.",
      moreRules: "+{count} more rules",
      managed: "managed",
      managedShort: "managed",
      observeOnly: "observe-only",
      adopt: "Adopt",
      planNetGuard: "Plan guard",
      cardTitle: "Baseline firewall inputs",
      cardDescription:
        "Legacy-compatible nft input rows. New NetGuard groups above compile back to the same lattice_guard renderer.",
      ...
      toastAdopted: "Node adopted into NetGuard",
      toastAdoptFailed: "Failed to adopt node",
    },
    ...
    wireguard: {
      ...
      description:
        "Plugin-owned WireGuard planner for interface addresses, peers, AllowedIPs, and approval-gated wg0.conf",
      ...
      statAddresses: "Mesh addresses",
      statOnlineMesh: "{count} online mesh nodes",
      statEndpoints: "Endpoints",
      statEndpointHint: "Peers with a public WireGuard endpoint.",
      statPlan: "Plan artifact",
      statPlanHint: "Rendered per node; private key substituted locally.",
      configModelTitle: "Configuration model",
      configModelDescription:
        "Preview of the same primitives the approval plan renders: one Interface block, peer public keys, endpoint hints, and host-route AllowedIPs.",
      noPreviewNode: "No node has a WireGuard address yet, so there is no wg0.conf preview.",
      previewNode: "Target",
      noPeers: "No mesh peers with WireGuard addresses yet.",
      previewConfig: "wg0.conf preview",
