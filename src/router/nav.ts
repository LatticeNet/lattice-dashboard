...
export const NAV: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "platform-notifications", title: "Notifications", path: "/platform/notifications", icon: Bell, scopes: ["notify:admin"] },
      ...
      { name: "platform-webhooks", title: "Webhooks", path: "/platform/webhooks", icon: Webhook, scopes: ["notify:admin"] },
